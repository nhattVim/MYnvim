...
M.jdtls_keys = {
    { "n", "<leader>J", "", "Java" },
    { "n", "<leader>Jo", function() require('jdtls').organize_imports() end, "Organize imports" },
    { "n", "<leader>Jt", function() require('jdtls').test_class() end, "Test class" },
    { "n", "<leader>JT", function() require('jdtls').test_nearest_method() end, "Test nearest method" },
    { "n", "<leader>Jv", function() require('jdtls').extract_variable() end, "Extract variable" },
    { "n", "<leader>Jc", function() require('jdtls').extract_constant() end, "Extract constant" },
}
...
M.whichkey = {
...

    {
        "<leader>g",
        group = "Git",
        { "<leader>gg", U.toggle_term("lazygit"), desc = "Lazygit" },
...

    {
        ...
        group = "Utils",
        mode = { "n", "v" },
        { "<leader>un", U.toggle_term("node"), desc = "Node" },
        { "<leader>uh", U.toggle_term("htop"), desc = "Htop" },
        { "<leader>ub", U.toggle_term("btop"), desc = "Btop" },
        { "<leader>up", U.toggle_term("python3"), desc = "Python" },
        { "<leader>ur", U.toggle_term("ranger"), desc = "Ranger" },
...

    {
        ...
        { "<leader>tr", "<cmd>lua require('neotest').run.run()<cr>", desc = "Test Nearest" },
